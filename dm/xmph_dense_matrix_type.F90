...
!> maphys dense matrix representation
!!
!! It is a simple encapsulation of blas matrices.
!!

Module XMPH_dense_matrix_type
  Implicit None
  ...
  Type XMPH_dense_matrix_t; sequence
...
End Module XMPH_dense_matrix_type
