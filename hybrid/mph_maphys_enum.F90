...
Module MPH_maphys_enum
  ...
  Integer, Parameter :: ICNTL_MAPHYSBIND          = 42
  ...
  Integer, Parameter :: IINFO_MAPHYS_MEMPEAK   = 24
  Integer, Parameter :: IINFO_MAPHYS_MEMUSED   = 25
  ...
  Integer, Parameter :: RINFO_DSCHUR_NORM1        = 2
  Integer, Parameter :: RINFO_DSCHUR_RCOND1       = 3
  Integer, Parameter :: RINFO_TIMING_Analysis     = 4
  Integer, Parameter :: RINFO_TIMING_Facto        = 5
  Integer, Parameter :: RINFO_TIMING_Precond      = 6
  Integer, Parameter :: RINFO_TIMING_Solve        = 7
  Integer, Parameter :: RINFO_TIMING_PrcInMat     = 8
  Integer, Parameter :: RINFO_TIMING_In2LcSys     = 9
  Integer, Parameter :: RINFO_TIMING_ExtBlocs     = 10
  Integer, Parameter :: RINFO_TIMING_FacLcMat     = 11
  Integer, Parameter :: RINFO_TIMING_GetSchur     = 12
  Integer, Parameter :: RINFO_TIMING_AsmsSchur    = 13
  Integer, Parameter :: RINFO_TIMING_PcdFacto     = 14
  Integer, Parameter :: RINFO_TIMING_SolveDistRHS = 15
  Integer, Parameter :: RINFO_TIMING_SolveGenRHS  = 16
  Integer, Parameter :: RINFO_TIMING_SolveITS     = 17
  Integer, Parameter :: RINFO_TIMING_SolveSDS     = 18
  Integer, Parameter :: RINFO_TIMING_SolveGathSol = 19
  Integer, Parameter :: RINFO_TIMING_AllSteps     = 20
  Integer, Parameter :: RINFO_TIMING_Total        = 21
  Integer, Parameter :: RINFO_FLOPS_FactoEstiElim = 22
  Integer, Parameter :: RINFO_FLOPS_FactoAssemb   = 23
  Integer, Parameter :: RINFO_FLOPS_FactoElim     = 24
  Integer, Parameter :: RINFO_FLOPS_PcdEstiElim   = 25
  Integer, Parameter :: RINFO_FLOPS_PcdAssemb     = 26
  Integer, Parameter :: RINFO_FLOPS_PcdElim       = 27
  Integer, Parameter :: RINFO_TIMING_SlvITSComm   = 28
  Integer, Parameter :: RINFO_TIMING_SlvITSMatV   = 29
  Integer, Parameter :: RINFO_TIMING_SlvITSPcdV   = 30
  Integer, Parameter :: RINFO_TIMING_SlvITSDotP   = 31
  Integer, Parameter :: RINFO_TIMING_Interp       = 32
  Integer, Parameter :: RINFO_RATIO_Lost          = 33
  Integer, Parameter :: RINFO_RATIO_Interp        = 34
  Integer, Parameter :: RINFO_PROC_INVOLVED       = 35
  !-------------------------------------------------------------------
  ! [1.8] RINFOG
  !-------------------------------------------------------------------
